...
class ForecastLoader:
    """Create train/val/test DataLoaders from the preprocessed npz data."""
    ...
    def __init__(
        ...
        # Record the parameters actually used to output/pred/meta.json;
        # postprocessing reads this so its settings match the training run
